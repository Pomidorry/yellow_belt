...
void test_no_roots()
{
    AssertEqual(GetDistinctRealRootCount(0, 0, 1), 0, "test_1_no_roots");
    AssertEqual(GetDistinctRealRootCount(0, 0, 1), 0, "test_2_no_roots");
    AssertEqual(GetDistinctRealRootCount(1, 0, 2), 0, "test_3_no_roots");
}
void test_linear_equation()
{
    AssertEqual(GetDistinctRealRootCount(0, -1, 12), 1, "test_1_linear_equation");
    AssertEqual(GetDistinctRealRootCount(0, 120, 44), 1, "test_2_linear_equation");
